...
public class ProgressLayout extends RelativeLayout {
    ...
    public void showError(@StringRes int stringId, @NonNull View.OnClickListener onClickListener) {
    ...
    public void showError(String str, String btnStr, @NonNull View.OnClickListener onClickListener) {
...
//    }
    ...
    private void showLoadingView() {
        ...
        if (loadingGroup == null) {
            loadingGroup = inflater.inflate(R.layout.base_layout_progress, null);
    ...
    private void showErrorView() {
        ...
        if (errorGroup == null) {
            errorGroup = inflater.inflate(R.layout.base_layout_error, null);
