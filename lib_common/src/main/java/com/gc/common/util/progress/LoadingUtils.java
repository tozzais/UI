package com.gc.common.util.progress;
	...
	public static void show(Context context, String dislogTip) {
		...
		if (!TextUtils.isEmpty(dislogTip)){
			dialog = new LoadingDialog(context,
					R.style.ActionSheetDialogStyle, R.layout.base_view_tips_loading,dislogTip);
		}else {
			dialog = new LoadingDialog(context,
					R.style.ActionSheetDialogStyle, R.layout.base_view_tips_loading);
		}
